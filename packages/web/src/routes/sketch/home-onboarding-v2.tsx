/**
 * /home/onboarding-v2 — the v2 onboarding prototype with the tabbed
 * help center (Contact / Videos / What's new) in place of v1's single
 * column of action rows.
 *
 * Flow + state machine are identical to v1. The only difference is the
 * Help panel — both the tray's expanded help panel and the post-setup
 * bubble panel render the shared HelpPanelV2 with three tabs:
 *   • Contact — Slack, WhatsApp, email, schedule a call
 *   • Videos — small library of feature walkthroughs
 *   • What's new — chronological product updates with type tags
 *
 * v1 remains live at /home/onboarding for side-by-side review.
 *
 * Original v1 doc:
 *
...
import { type BubbleStep, OnboardingBubbleHelperV2 } from "@/components/sketch/onboarding-bubble-helper-v2";
import { OnboardingSetupTrayV2, type OnboardingStep } from "@/components/sketch/onboarding-setup-tray-v2";
...
export const homeOnboardingV2Route = createRoute({
  getParentRoute: () => sketchRoute,
  path: "/home/onboarding-v2",
